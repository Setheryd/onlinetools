...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://thetool.guru/tools/compound-interest-calculator',
  },
  openGraph: {
    title: 'Compound Interest Calculator — The Tool Guru',
    description: 'Compute future value with compounding and periodic contributions.',
    url: 'https://thetool.guru/tools/compound-interest-calculator',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: 'Compound Interest Calculator — The Tool Guru - The Tool Guru',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const CompoundInterestCalculatorPage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <RelatedToolsSection toolId="compound-interest-calculator" />
