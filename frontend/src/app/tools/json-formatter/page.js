...
export const metadata = {
  title: 'JSON Formatter & Validator — Free Online | The Tool Guru',
  description: 'Free json formatter and validator online. Format, validate, and beautify JSON with syntax highlighting. No signup.',
  keywords: ['json formatter', 'json validator', 'json formatter online', 'json beautifier', 'validate json', 'the tool guru'],
  alternates: {
    canonical: 'https://thetool.guru/tools/json-formatter',
  },
  openGraph: {
    title: 'JSON Formatter & Validator — Free Online | The Tool Guru',
    description: 'Free json formatter and validator online. Format and validate JSON with syntax highlighting.',
  ...
  twitter: {
    ...
    title: 'JSON Formatter & Validator — Free Online | The Tool Guru',
    description: 'Free json formatter and validator online. Format and validate JSON.',
...
const JsonFormatterPage = async () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <RelatedToolsSection toolId="json-formatter" />
