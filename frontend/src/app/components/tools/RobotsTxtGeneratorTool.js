...
const RobotsTxtGeneratorTool = () => {
  ...
  const [sitemaps, setSitemaps] = useState(['https://thetoolguru.com/sitemap.xml']);
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md border border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <ListField label="Sitemap URLs" values={sitemaps} setValues={setSitemaps} placeholder="https://thetoolguru.com/sitemap.xml" />
        </div>
        <div>
